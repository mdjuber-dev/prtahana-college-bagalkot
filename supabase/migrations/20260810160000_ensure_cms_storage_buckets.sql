-- Ensure CMS storage buckets exist (idempotent, non-destructive)
-- Primary bucket: cms-assets (images, PDFs, pamphlets)
-- Legacy alias: cms-media (read-compatible; uploads prefer cms-assets)
...
-- site_cms updated_at auto-update
...
-- Ensure public can insert popup/contact enquiries
...
-- Admin read site_cms (authenticated admins)
