...
export const pageMeta: Record<string, PageMeta> = {
  ...
  '/transport': { title: 'Transport Facility | Prarthana PU Science College Bagalkot', description: 'Transport facility information for Prarthana PU Science College students in and around Bagalkot.', keywords: 'Prarthana PU College transport, PU college bus facility Bagalkot', canonical: '/transport' },
